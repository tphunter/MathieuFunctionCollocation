...
[d_s,PHI_jump]=PW_comp(0.1,@(x) 0*x+thickness,K,beta,0);
D_nonlin_h1_1=d_s; p_nonlin_h1_1=PHI_jump{1};
[d_s,PHI_jump]=PW_comp(0.1,@(x) 0*x+thickness,K,0,0);
D_lin_h1_1=d_s; p_lin_h1_1=PHI_jump{1};

[d_s,PHI_jump]=PW_comp(1,@(x) 0*x+thickness,K,beta,0);
D_nonlin_h1_2=d_s; p_nonlin_h1_2=PHI_jump{1};
[d_s,PHI_jump]=PW_comp(1,@(x) 0*x+thickness,K,0,0);
D_lin_h1_2=d_s; p_lin_h1_2=PHI_jump{1};

[d_s,PHI_jump]=PW_comp(10,@(x) 0*x+thickness,K,beta,0);
D_nonlin_h1_3=d_s; p_nonlin_h1_3=PHI_jump{1};
[d_s,PHI_jump]=PW_comp(10,@(x) 0*x+thickness,K,0,0);
